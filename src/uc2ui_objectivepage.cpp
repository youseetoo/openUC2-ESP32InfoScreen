...
namespace uc2ui_objectivepage
{
    ...
    void initUI(lv_obj_t * container)
    {
        ...
        lv_obj_set_height(slot_container, 80);
        ...
        lv_obj_set_height(slot2Button, 60);
